...
public class BookingHandler {
    ...
    // int movieIndex = context.scanner.nextInt();
    // context.scanner.nextLine();
    // Movie selectedMovie = context.movieManager.getMovie(movieIndex);
    ...
    // ":");
    // context.showtimeManager.listShowtimesForMovie(selectedMovie);
    // System.out.print("Select the index of the showtime you want to book: ");
    // int showtimeIndex = context.scanner.nextInt();
    // context.scanner.nextLine();
    // Showtime selectedShowtime =
    // context.showtimeManager.getShowtime(showtimeIndex);
    ...
    // System.out.print("Enter the seat numbers you want to book (comma-separated,
    // e.g., 1,2): ");
    // String seatInput = context.scanner.nextLine();
    // String[] seatNumbers = seatInput.split(",");
    ...
    // Payment payment = PaymentHandler.selectPaymentMethod(context.scanner, user,
    // totalCost);
    // if (payment != null) {
